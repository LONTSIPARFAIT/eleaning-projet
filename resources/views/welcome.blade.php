...
<body class="antialiased bg-gradient-to-br from-blue-50 to-orange-100 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 px-4">
        ...
        <div class="container mx-auto flex justify-between items-center px-4">
            ...
            <div class="flex items-center space-x-4">
                ...
                <button @click="darkMode = !darkMode; document.documentElement.classList.toggle('dark')" class="p-2 rounded-md text-white hover:text-orange-300 dark:hover:text-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-500 transition duration-150 ease-in-out">
                    ...
                    <span x-show="darkMode" class="hidden">
    ...
    <section id="cours" class="py-16 mx-auto max-w-7xl scroll-reveal">
        <h2 class="text-center text-3xl sm:text-4xl font-bold text-blue-900 dark:text-orange-400 mb-12"><i class="fas fa-graduation-cap mr-2"></i>Cours Populaires</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            @forelse ($cours->take(6) as $cour)
                <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl border border-orange-200 dark:border-orange-600">
                    ...
                    <form action="{{ route('cours.subscribe', $cour->id) }}" method="POST" class="mt-4">
                        @csrf
                        <button type="submit" class="bg-blue-500 hover:bg-blue-600 dark:bg-orange-500 dark:hover:bg-orange-600 text-white font-semibold py-2 px-4 rounded-lg transition duration-300"><i class="fas fa-plus-circle mr-2"></i>S'abonner</button>
                    </form>
                </div>
            @empty
    ...
    <section id="features" class="py-16 mx-auto max-w-7xl bg-orange-50 dark:bg-gray-900 scroll-reveal">
        <h2 class="text-center text-3xl sm:text-4xl font-bold text-blue-900 dark:text-orange-400 mb-12">Pourquoi choisir CFPC-Learning ?</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <h3 class="text-xl font-semibold text-red-600 dark:text-orange-400"><i class="fas fa-clock mr-2"></i>Flexibilité</h3>
                <p class="mt-2 text-gray-700 dark:text-gray-300">Apprenez à votre rythme, où et quand vous voulez.</p>
            </div>
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <h3 class="text-xl font-semibold text-red-600 dark:text-orange-400"><i class="fas fa-users mr-2"></i>Interactivité</h3>
                <p class="mt-2 text-gray-700 dark:text-gray-300">Échangez avec des enseignants et d'autres apprenants.</p>
            </div>
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <h3 class="text-xl font-semibold text-red-600 dark:text-orange-400"><i class="fas fa-certificate mr-2"></i>Certifications</h3>
                <p class="mt-2 text-gray-700 dark:text-gray-300">Obtenez des certificats reconnus à la fin des cours.</p>
            </div>
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <h3 class="text-xl font-semibold text-red-600 dark:text-orange-400"><i class="fas fa-headset mr-2"></i>Support</h3>
    ...
    <section id="about" class="py-16 mx-auto max-w-7xl scroll-reveal">
        <h2 class="text-center text-3xl sm:text-4xl font-bold text-blue-900 dark:text-orange-400 mb-12"><i class="fas fa-info-circle mr-2"></i>À propos de nous</h2>
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6 max-w-4xl mx-auto">
            <p class="text-gray-700 dark:text-gray-300 text-lg">CFPC-Learning est une plateforme dédiée à l’éducation en ligne, conçue pour offrir des cours de qualité à tous, quel que soit leur niveau ou leur emploi du temps. Notre mission est de rendre l’apprentissage accessible, interactif et efficace grâce à une équipe d’enseignants passionnés et des outils modernes.</p>
            <p class="mt-4 text-gray-700 dark:text-gray-300 text-lg">Rejoignez-nous pour développer vos compétences et atteindre vos objectifs avec une expérience d’apprentissage personnalisée.</p>
        </div>
    </section>

    <!-- Section Témoignages -->
    <section id="testimonials" class="py-16 mx-auto max-w-7xl scroll-reveal">
        <h2 class="text-center text-3xl sm:text-4xl font-bold text-blue-900 dark:text-orange-400 mb-12"><i class="fas fa-quote-left mr-2"></i>Témoignages</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="bg-orange-50 dark:bg-gray-800 shadow-lg rounded-xl p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
    ...
    <section id="contact" class="py-16 mx-auto max-w-7xl scroll-reveal">
        <h2 class="text-center text-3xl sm:text-4xl font-bold text-blue-900 dark:text-orange-400 mb-12"><i class="fas fa-envelope mr-2"></i>Contactez-nous</h2>
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6 max-w-2xl mx-auto">
            <form action="#" method="POST" class="space-y-6">
                @csrf
                <div>
                    <label for="name" class="block text-gray-700 dark:text-gray-300 font-semibold"><i class="fas fa-user mr-2"></i>Nom</label>
                    <input type="text" id="name" name="name" class="w-full mt-2 p-3 border border-orange-200 dark:border-orange-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-orange-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200" required>
                </div>
                <div>
                    <label for="email" class="block text-gray-700 dark:text-gray-300 font-semibold"><i class="fas fa-envelope mr-2"></i>Email</label>
                    <input type="email" id="email" name="email" class="w-full mt-2 p-3 border border-orange-200 dark:border-orange-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-orange-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200" required>
                </div>
                <div>
                    <label for="message" class="block text-gray-700 dark:text-gray-300 font-semibold"><i class="fas fa-comment mr-2"></i>Message</label>
                    <textarea id="message" name="message" rows="4" class="w-full mt-2 p-3 border border-orange-200 dark:border-orange-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-orange-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200" required></textarea>
                </div>
                <button type="submit" class="w-full bg-red-500 hover:bg-red-600 dark:bg-orange-500 dark:hover:bg-orange-600 text-white font-semibold py-3 rounded-lg shadow-lg transition duration-300"><i class="fas fa-paper-plane mr-2"></i>Envoyer</button>
            </form>
        </div>
    </section>

    <!-- Section Appel à l'Action -->
    <section class="py-16 bg-gradient-to-r from-red-500 to-red-700 dark:from-gray-800 dark:to-gray-700 text-center mx-auto max-w-7xl scroll-reveal">
        ...
        <p class="text-lg text-gray-200 dark:text-gray-300 mb-8">Inscrivez-vous dès maintenant et accédez à des cours de qualité.</p>
        <a href="{{ route('register') }}" class="inline-block bg-orange-500 hover:bg-orange-600 dark:bg-orange-600 dark:hover:bg-orange-700 text-white font-semibold py-3 px-8 rounded-lg shadow-lg transition duration-300"><i class="fas fa-user-plus mr-2"></i>S'inscrire Maintenant</a>
    </section>
    ...
    <footer class="bg-blue-900 dark:bg-gray-900 text-white p-6 text-center scroll-reveal">
        ...
        <div class="mt-2 space-x-4">
            <a href="#privacy" class="hover:text-orange-300 dark:hover:text-orange-400 transition">Politique de confidentialité</a>
            <a href="#terms" class="hover:text-orange-300 dark:hover:text-orange-400 transition">Conditions d'utilisation</a>
        </div>
    </footer>
