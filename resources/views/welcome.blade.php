...
<body class="antialiased bg-gray-100 p-6 dark:bg-gray-900 mx-2">
    ...
    <nav class="bg-gradient-to-r from-red-400 to-red-600 p-6 pr-6 shadow-lg fixed w-full z-10 min-h-5">
    ...
    <section class="py-4 bg-red-600 text-white">
        <div class="container mx-auto text-center">
            ...
            <a href="#courses" class="mt-4 inline-block bg-white hover:bg-gray-00 text-red-500 font-semibold py-2 px-4 rounded">Voir les Cours</a>
        </div>
    </section>
