...
<body
    ...
    <div class="relative h-screen mx-auto max-w-7xl bg-center bg-cover"
        ...
        <div class="relative flex flex-col justify-center items-start h-full text-left px-6 sm:px-12">
            ...
            <p class="text-lg sm:text-xl text-gray-200 dark:text-gray-300 max-w-2xl mb-8">Rejoignez une plateformed'apprentissage en ligne conçue pour tous les niveaux, avec des cours interactifs et flexibles.</p>
