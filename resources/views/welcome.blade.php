...
<body class="antialiased bg-gray-100 dark:bg-gray-900 mx-2">
    ...
    <nav class="bg-gradient-to-r from-teal-400 to-teal-600 p-4 shadow-lg fixed w-full z-10 min-h-5">
        <div class="container mx-auto flex justify-between items-center">
            <div>
                <a href="#" class="text-white font-bold text-2xl transition duration-300 hover:scale-105"><img src="/img/logo.png" class="h-[4rem] w-[6rem] rounded" alt="Logo-Eleaning App"/></a>
            </div>
                ...
                @if (Route::has('login'))
                    @auth
                        ...
                        @elseif (auth()->user()->role === 'admin')
                            <a href="{{ url('admin.dashboard') }}" class="font-semibold text-white border-b-2 border-transparent hover:border-white transition duration-300">Dashboard Admin</a>
                        @else
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 font-semibold bg-white text-teal-600 p-2 rounded border border-teal-600 hover:bg-gray-200 transition duration-300">Inscription</a>
                        @endif
                    @endauth
                @endif
            </div>
    ...
    <div class="relative my-5 mx-2 bg-dots-darker bg-center  bg-cover selection:bg-red-500 selection:text-white p-8" style="background-image: url('img/photo.png'); min-height: 80vh; height: 60vh;">
        <div class="flex flex-col justify-center items-center h-full ">
            ...
            <div class="mt-8">
                <a href="#courses" class="inline-block bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3 px-6 rounded transition duration-300">Voir les Cours</a>
    ...
    <section class="py-4 bg-teal-600 text-white">
        <div class="container mx-auto text-center">
            ...
            <a href="#courses" class="mt-4 inline-block bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded">Voir les Cours</a>
        </div>
    </section>
