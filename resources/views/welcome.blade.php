    ...
    <nav x-data="{ visible: false, mobileOpen: false }"
        ...
        <div class="container mx-auto flex justify-between items-center px-4">
            ...
            <div class="flex items-center space-x-4">
                <!-- Dark Mode Toggle -->
                <button @click.stop="darkMode = !darkMode; localStorage.setItem('darkMode', darkMode); console.log('Dark Mode:', darkMode)" class="p-2 rounded-md text-white hover:text-orange-300 dark:hover:text-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-500 transition duration-150 ease-in-out">
