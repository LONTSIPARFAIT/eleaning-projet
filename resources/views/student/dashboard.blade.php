                ...
                @foreach ($studentCourses as $course)
                    ...
                    >
                        ...
                        <a
                            ...
                            class="mt-4 inline-block bg-red-500 hover:bg-red-600 dark:bg-orange-500 dark:hover:bg-orange-600 text-white font-semibold py-2 px-4 rounded-lg transition-all duration-300 hover:shadow-lg items-center gap-2"
                        >
