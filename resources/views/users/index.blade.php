        ...
        <table class="w-full">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-200 bg-white border-gray-200 dark:border-gray-600">
                    ...
                    <td class="py-2 px-4">
                        <a href="{{ route('users.show', $user->id) }}" class="text-red-500 hover:text-red-700 font-bold mr-2">Voir</a>
                        <a href="{{ route('users.edit', $user->id) }}" class="text-red-500 hover:text-red-700 font-bold mr-2">Modifier</a>
