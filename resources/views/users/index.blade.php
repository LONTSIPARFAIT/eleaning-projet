    ...
    <div
        ...
        <div
            ...
            <table class="min-w-full table-auto divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-red-600 dark:bg-gray-800 text-white">
                    <tr>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @foreach ($users as $user)
                        <tr
                            ...
                            <td class="py-3 px-4 text-sm text-gray-700 dark:text-@extends('layouts.admin')

@section('title', 'Liste des utilisateurs')

@section('content')
<div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 to-orange-100 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 min-h-screen">
    <h1 class="text-3xl font-bold mb-6 text-blue-900 dark:text-orange-400 animate-fade-in-down flex items-center gap-2">
    ...
    <div class="flex justify-end mb-6 scroll-reveal">
        <a href="{{ route('users.create') }}" class="bg-red-500 hover:bg-red-600 dark:bg-orange-500 dark:hover:bg-orange-600 text-white py-2 px-4 rounded-lg shadow-md transition duration-300 ease-in-out flex items-center gap-2">
    ...
    <!-- Conteneur avec débordement horizontal -->
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-x-auto scroll-reveal border border-blue-200 dark:border-gray-700">
        <table class="min-w-full table-auto divide-y divide-gray-200 dark:divide-gray-700">
            <thead class="bg-red-600 dark:bg-gray-800 text-white">
                <tr>
                    <th class="py-3 px-4 text-left text-sm font-semibold">Nom</th>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                @foreach ($users as $user)
                    <tr class="hover:bg-orange-50 dark:hover:bg-gray-700 bg-white dark:bg-gray-800 transition duration-200">
                        ...
                        <td class="py-3 px-4 text-sm">
                            <form action="{{ route('users.updateRole', $user->id) }}" method="POST" class="inline-block w-full">
                                @csrf
                                @method('PUT')
                                <select name="role" onchange="this.form.submit()" class="bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-md w-full text-sm border-blue-300 dark:border-gray-600 focus:border-red-500 dark:focus:border-orange-500 focus:ring-red-500 dark:focus:ring-orange-500 transition duration-200">
                        ...
                        <td class="py-3 px-4 text-sm">
                            <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                                <a href="{{ route('users.show', $user->id) }}" class="text-blue-500 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-semibold transition duration-200 flex items-center gap-1">
                                ...
                                <a href="{{ route('users.edit', $user->id) }}" class="text-green-500 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300 font-semibold transition duration-200 flex items-center gap-1">
                            ...
                            <td class="py-3 px-4 text-sm">
                                <form action="{{ route('users.updateRole', $user->id) }}" method="POST"
                                    ...
                                    <select name="role" onchange="this.form.submit()"
                                        ...
                                        <option value="student" {{ $user->role == 'student' ? 'selected' : '' }}>Étudiant
                                        </option>
                                        <option value="teacher" {{ $user->role == 'teacher' ? 'selected' : '' }}>Enseignant
                                        </option>
