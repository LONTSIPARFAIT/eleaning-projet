    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-gradient-to-r from-blue-100 to-orange-100 dark:from-gray-900 dark:to-gray-800 border-t border-blue-200 dark:border-orange-600">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @endif
                        ...
                        <!-- Dans le dropdown, après "Se Déconnecter" -->
<div class="mt-3">
    <button @click="document.documentElement.classList.toggle('dark')" class="w-full text-left px-4 py-2 text-sm text-blue-800 dark:text-orange-500 hover:bg-orange-200 dark:hover:bg-gray-700 flex items-center gap-2">
