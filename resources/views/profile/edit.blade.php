<x-app-layout>
  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-orange-100 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 py-12 px-4">
              ...
              <div class="max-w-xl">
                  ...
                  <section class="space-y-6">
                      ...
                      <x-danger-button
                          ...
                          class="bg-red-500 hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700 text-white transition duration-300 ease-in-out shadow-md animate-fade-in-up"
      ...
      <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
          <form method="post" action="{{ route('profile.destroy') }}" class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-blue-200 dark:border-gray-700">
              @csrf
              @method('delete')
              ...
              <div class="mt-6 flex justify-end gap-3 animate-fade-in-up">
                  <x-secondary-button x-on:click="$dispatch('close')" class="bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 transition duration-300 ease-in-out">
                      {{ __('Annuler') }}
                  </x-secondary-button>

                  <x-danger-button class="bg-red-500 hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700 text-white transition duration-300 ease-in-out shadow-md">
