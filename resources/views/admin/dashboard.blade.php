    ...
    <div class="container mx-auto scroll-reveal">
        ...
        <div class="bg-orange-50 shadow-lg rounded-xl p-6 border border-blue-200">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="#" class="text-red-500 hover:text-red-600 hover:underline font-semibold transition duration-300">Voir tous les utilisateurs</a>
            </div>
    ...
    <div class="container mx-auto mt-8 scroll-reveal">
        ...
        <div class="bg-orange-50 shadow-lg rounded-xl p-6 border border-blue-200">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="#" class="text-red-500 hover:text-red-600 hover:underline font-semibold transition duration-300">Voir tous les cours</a>
            </div>
            <table class="w-full text-left">
                <thead>
                    <tr class="bg-blue-100 text-blue-900">
