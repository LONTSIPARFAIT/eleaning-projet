...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-blue-50 to-orange-100 px-4 py-8">
        ...
        <div class="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 scroll-reveal">
            <div
                class="bg-orange-50 shadow-lg rounded-xl p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl border border-blue-200">
            ...
            <div class="bg-orange-50 shadow-lg rounded-xl p-6 border border-blue-200">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="{{ route('admin.users.index') }}"
                        class="text-red-500 hover:text-red-600 hover:underline font-semibold transition duration-300">Voir
                ...
                <table class="w-full text-left">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="py-3 px-4 text-gray-600 text-center">Aucun utilisateur récent.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
        ...
        <div class="container mx-auto mt-8 scroll-reveal">
            ...
            <div class="bg-orange-50 shadow-lg rounded-xl p-6 border border-blue-200">
                ...
                <a href="{{ route('admin.settings') }}"
                    class="text-red-500 hover:text-red-600 hover:underline font-semibold transition duration-300">Modifier
                    les Paramètres</a>
            </div>
        </div>
