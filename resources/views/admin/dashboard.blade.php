<x-app-layout>
  ...
  <div class="mt-4 ml-6">
    ...
    <ul class="mt-4 ml-6">
      <li>
        <a href="{{ route('cours.create') }}" class="bg-red-500 hover:bg-red-700 text-white p-3 rounded">
  ...
  <div class="py-12 bg-white">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-red-500">
        <div class="p-6 text-red-700 bg-white">

          <!-- Cards de statistiques -->
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            <div class="hover:bg-red-50 bg-white rounded-lg shadow-md p-4 border border-red-200">
