...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-orange-100 py-8 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
    <div class="bg-white shadow-lg rounded-xl p-6 sm:p-8 max-w-lg w-full scroll-reveal border border-blue-200">
        <h1 class="text-3xl font-bold text-blue-800 text-center mb-6 animate-fade-in-down">Éditer le Cours</h1>
        ...
        <form action="{{ route('cours.update', $cour) }}" method="POST" class="space-y-6">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up">
                <button 
                    type="submit" 
                    class="bg-red-500 hover:bg-red-600 text-white font-bold p-3 rounded-lg shadow-md transition duration-300 ease-in-out w-full sm:w-auto"
                >
                    Modifier le cours
                </button>
                <a 
                    href="{{ route('cours.index') }}" 
                    class="bg-orange-500 hover:bg-orange-600 text-white font-bold p-3 rounded-lg shadow-md transition duration-300 ease-in-out text-center w-full sm:w-auto"
                >
                    Retour
                </a>
            </div>
