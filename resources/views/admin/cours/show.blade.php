...
@section('content')
            ...
            <div class="bg-white shadow-lg rounded-xl p-6 mb-6 scroll-reveal border border-blue-200">
                ...
                <div class="flex flex-col sm:flex-row gap-4 animate-fade-in-up">
                    ...
                    <form action="{{ route('cours.destroy', $cour) }}" method="POST" class="inline">
                        ...
                        @method('DELETE')
                        <button type="submit"
                            class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-300 ease-in-out flex items-center gap-2"
    ...
    Supprimer
                    ...
                    <a href="{{ route('cours.index') }}"
                        class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-300 ease-in-out flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="bg-white shadow-lg rounded-xl p-6 mb-6 scroll-reveal border border-blue-200 relative">
                ...
                <div class="absolute top-4 right-4 flex gap-2 animate-fade-in-up">
                    <a href="{{ route('lessons.create', ['cours_id' => $cour->id]) }}"
                        class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-300 ease-in-out flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('cours.lessons.index', ['cours_id' => $cour->id]) }}"
                        class="bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-300 ease-in-out flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        @foreach ($cour->lessons as $index => $lesson)
                            <li class="border-b pb-4 animate-fade-in-up">
                                ...
                                <a href="{{ route('lessons.show', $lesson->id) }}"
                                    class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-1 px-3 rounded-md transition duration-200 inline-block mt-2 flex items-center gap-1">
            ...
            <div class="bg-white shadow-lg rounded-xl p-6 mb-6 scroll-reveal border border-blue-200 relative">
                <h2 class="text-xl font-bold text-blue-800 mb-4 animate-fade-in-down flex items-center gap-2">
                    <svg class="w-6 h-6 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5H5a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-4M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2">
                        </path>
                    </svg>
                    Exercices
                </h2>
                <div class="absolute top-4 right-4 flex gap-2 animate-fade-in-up">
                    <a href="{{ route('exercises.create', ['cours_id' => $cour->id]) }}"
                        class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-300 ease-in-out flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('cours.exercises.index', $cour->id) }}"
                        class="bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-300 ease-in-out flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                @else
                    <ul class="space-y-4">
                        @foreach ($cour->exercises as $index => $exercise)
                            <li class="border-b pb-4 animate-fade-in-up">
                                <h3 class="font-bold text-blue-900">Exercice {{ $index + 1 }} : {{ $exercise->title }}
                                </h3>
            ...
            <div class="bg-white shadow-lg rounded-xl p-6 mb-6 scroll-reveal border border-blue-200 relative">
                ...
                <div class="absolute top-4 right-4 flex gap-2 animate-fade-in-up">
                    <a href="{{ route('quizzes.create', ['lesson_id' => $cour->id]) }}"
                        class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-300 ease-in-out flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('cours.quizzes.index', $cour->id) }}"
                        class="bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-300 ease-in-out flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
