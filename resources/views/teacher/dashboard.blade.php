...
@section('content')
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-gradient-to-br from-blue-50 to-orange-100"
        ...
        <div
            class="bg-orange-50 shadow-lg rounded-xl p-6 mb-6 border border-blue-200 scroll-reveal flex justify-between items-center">
            <h4 class="text-blue-900 text-2xl font-bold">Enseignant</h4>
            <a href="{{ route('cours.create') }}"
                class="bg-red-500 hover:bg-red-600 text-white px-6 py-2 rounded-lg shadow-md transition duration-300 ease-in-out">
            ...
            <div class="bg-orange-50 shadow-lg rounded-xl p-6 animate-slide-in-up border border-blue-200">
                <table class="w-full text-left">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="2" class="py-3 px-4 text-gray-600 text-center">Aucun cours créé récemment.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
        ...
        <div class="mt-8 scroll-reveal">
            ...
            <div class="bg-orange-50 shadow-lg rounded-xl p-6 animate-slide-in-up border border-blue-200">
                <p class="text-gray-700">Nouveaux messages des étudiants : <span
                        class="font-bold text-red-600">{{ $newMessagesCount ?? 3 }}</span></p>
                <a href="" {{-- {{ route('teacher.messages') }} --}}
                    class="text-red-500 hover:text-red-600 hover:underline transition-colors duration-200 mt-2 inline-block">Voir
                    tous les messages</a>
            </div>
        </div>
        ...
        <div class="mt-8 scroll-reveal">
            ...
            <div class="bg-orange-50 shadow-lg rounded-xl p-6 animate-slide-in-up border border-blue-200">
                <a href="" {{-- {{ route('teacher.calendar') }} --}}
                    class="text-red-500 hover:text-red-600 hover:underline transition-colors duration-200">Voir le
                    Calendrier</a>
            </div>
        </div>
    </div>
