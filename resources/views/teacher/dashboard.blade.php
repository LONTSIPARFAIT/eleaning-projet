...
@section('content')
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-gradient-to-br from-blue-50 to-orange-100" x-data="{ activeSection: 'cours' }">
        ...
        <div class="bg-orange-50 shadow-lg rounded-xl p-6 mb-6 border border-blue-200 scroll-reveal flex justify-between items-center">
            ...
            <a href="{{ route('cours.create') }}" class="bg-red-500 hover:bg-red-600 text-white px-6 py-2 rounded-lg shadow-md transition duration-300 ease-in-out flex items-center gap-2">
        ...
        <div class="mt-8 scroll-reveal">
            ...
            <div class="bg-orange-50 shadow-lg rounded-xl p-6 animate-slide-in-up border border-blue-200">
                <a href="" {{-- {{ route('teacher.assignments.create') }} --}}
                    class="text-red-500 hover:text-red-600 hover:underline font-semibold transition-colors duration-200 flex items-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
        ...
        <div class="mt-8 scroll-reveal">
            <h2 class="text-xl sm:text-2xl font-semibold mb-4 text-blue-800 animate-fade-in flex items-center gap-2">
                <svg class="w-6 h-6 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"></path></svg>
            ...
            <div class="bg-orange-50 shadow-lg rounded-xl p-6 animate-slide-in-up border border-blue-200">
                ...
                <a href="" {{-- {{ route('teacher.messages') }} --}}
                    class="text-red-500 hover:text-red-600 hover:underline transition-colors duration-200 mt-2 inline-block flex items-center gap-2">
